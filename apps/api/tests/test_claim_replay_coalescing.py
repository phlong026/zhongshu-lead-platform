...
from apps.api.src.core.models import Assignment, AssignmentEvent, AuditLog, Company, Lead, PointsAccount, PointsLedger, User
...
def _prepare_claim(factory) -> tuple[str, str]:
    with factory() as db:
        ...
        lead = Lead(
            ...
            customer_name="P71 replay customer",
            ...
            brand_code="ZHONGSHU",
            need_summary="P71 replay coalescing",
        ...
        assignment = Assignment(
            ...
            idempotency_key="p71-replay-assignment",
        )
        db.add(assignment)
        db.flush()
