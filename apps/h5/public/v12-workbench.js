...
async function profile(){
  ...
  shell('<section class="wb-hero"><h1>公司资料与接单能力</h1><p>供客能力、接收能力和服务区域分别审核。接收能力与区域都生效后，才会进入派单候选。</p><div class="wb-kpis"><div class="wb-kpi"><b>'+approvedCapabilities+'</b><span>已开通能力</span></div><div class="wb-kpi"><b>'+pendingCapabilities+'</b><span>待审能力</span></div><div class="wb-kpi"><b>'+approvedAreas+'</b><span>当前有效区域</span></div><div class="wb-kpi"><b>'+primaryCities.size+'</b><span>主要城市</span></div></div></section>'+messageCard+'<div class="wb-profile-grid"><section class="wb-card"><div class="wb-card-head"><div><h2>公司客资能力</h2><p>供客与接收能力独立申请、独立启停。</p></div></div><div class="wb-list">'+Object.keys(CAPABILITY_META).map(code=>capabilityCard(capabilities,code)).join('')+'</div></section><section class="wb-card"><div class="wb-card-head"><div><h2>服务区域</h2><p>主要城市必须包含在申请中，区县与城市一起审核。</p></div><button class="wb-btn primary" id="service-area-edit">申请/更新</button></div><div class="wb-list" id="service-area-list">'+areaCards+'</div></section></div>');
