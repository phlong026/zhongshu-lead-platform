...
function franchiseHomeGreeting(){const role=isFranchiseOwner()?'加盟商负责人':'加盟商员工';const name=String(S.me?.display_name||'').trim()||role;return `<section class="wb-home-greeting"><div><p>${role}</p><h1>${esc(greetingName(name))}，上午好</h1></div></section>`}
