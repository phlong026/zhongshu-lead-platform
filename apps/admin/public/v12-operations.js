...
const S={me:null,view:'overview',id:'',status:'',page:1,processedPage:1,processedCreatedFrom:beijingToday(),processedCreatedTo:beijingToday(),leadSource:'',leadCreatedFrom:'',leadCreatedTo:'',leadStatusFilter:'',assignmentStatusFilter:'',leadAssignerId:'',leadSubmitterId:'',leadPhone:'',leadRegion:'',leadReceiverCompanyId:'',leadFilterOptions:null,operationUsers:null,platformLeads:[],supplierLeads:[],financeRewardPage:1,financeCompanyKeyword:'',financeCompanyStatus:'',financeCompanyPage:1,financeCompanyId:'',financeLedgerType:'',financeDays:30,financeRewardStatus:'',financeSource:'',platformCities:null,platformDistricts:[],companyKeyword:'',companyLifecycleStatus:'',companyPage:1,telesalesUsers:null,calendarMonth:'',unreadNotifications:0,accountNotifications:[]};
...
async function review(){
  ...
  const sourceOptions=[['','全部来源'],['PLATFORM_MANUAL','平台录入'],['SUPPLIER_H5','加盟商提交'],['FEISHU_LEGACY','飞书历史导入']].filter(([value])=>!value||(value==='SUPPLIER_H5'?canSupplier:canPlatform));
...
async function savePlatformLead(item,correction=false){
  ...
  try{
    ...
    closeModal();toast(correction?'客资更正已保存，异常会标记待运营处理':'平台客资草稿已保存');await review()
