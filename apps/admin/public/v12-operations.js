...
const S={me:null,view:'overview',id:'',status:'',page:1,processedPage:1,processedCreatedFrom:beijingToday(),processedCreatedTo:beijingToday(),leadSource:'',leadCreatedFrom:'',leadCreatedTo:'',leadStatusFilter:'',assignmentStatusFilter:'',leadAssignerId:'',leadSubmitterId:'',leadPhone:'',leadRegion:'',leadReceiverCompanyId:'',leadFilterOptions:null,operationUsers:null,platformLeads:[],supplierLeads:[],publicPoolKeyword:'',publicPoolCustomerSource:'',publicPoolSource:'',publicPoolCompleteness:'',publicPoolDuplicate:'',financeRewardPage:1,financeCompanyKeyword:'',financeCompanyStatus:'',financeCompanyPage:1,financeCompanyId:'',financeLedgerType:'',financeDays:30,financeRewardStatus:'',financeSource:'',platformCities:null,platformDistricts:[],companyKeyword:'',companyLifecycleStatus:'',companyPage:1,telesalesUsers:null,calendarMonth:'',unreadNotifications:0,accountNotifications:[]};
...
async function publicPool(){
  const data=await api(`/v1.2/public-pool/leads${qs({page:S.page,page_size:20,keyword:S.publicPoolKeyword||undefined,customer_source:S.publicPoolCustomerSource||undefined,source_kind:S.publicPoolSource||undefined,completeness:S.publicPoolCompleteness||undefined,duplicate_status:S.publicPoolDuplicate||undefined})}`);
