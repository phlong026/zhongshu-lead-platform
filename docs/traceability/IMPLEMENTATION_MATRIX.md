...
| NTF | 状态变化通知、公司资料审核通知、站内消息、Outbox、业务深链 | `apps/api/src/services/notification_v12.py`、`apps/api/src/services/outbox_worker.py` | `apps/h5/public/v12-workbench.html`、`apps/admin/public/v12-operations.html` | `apps/api/tests/test_v12_sprint5_notifications.py`：自动化通过 | 待真实微信发送、失败重试和深链 UAT；需配置公司资料审核事件模板 |
